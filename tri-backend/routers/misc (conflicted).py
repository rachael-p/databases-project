...
# returns total releases per epa region for a given year
...
# returns top n cities by air releases between start and end year range
...
# returns top industry by total releases per epa region for a given year
